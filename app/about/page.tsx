...
const About = () => {
  return (
    <section className="flex flex-col justify-center py-10 sm:py-20 size-full  overflow-x-hidden items-center gap-16 sm:gap-16 px-5 sm:px-10 lg:px-[90] relative ">
      <Hero_Section />
      <About_Section />
      <Resume_Section />
    </section>
