...
export const Services_Section = () => {
  return (
    <section className="flex flex-col gap-0  size-full">
      <div className="w-full  bg-[url('/bg-play.svg')] bg-cover sm:bg-contain bg-no-repeat bg-[#111111] text-[#FEFEFE]  sm:rounded-t-4xl   rounded-t-2xl">
        <div className=" backdrop-brightness-30 flex py-16 sm:py-20 3xl:py-[128] px-7 sm:px-12 lg:px-[90] flex-col gap-12 3xl:gap-[88]">
          <H_Tag className="3xl:text-[91px]! font-bold leading-[140%]! text-[35px]! sm:text-5xl! lg:text-6xl! sm:font-normal sm:leading-[120%]! 3xl:w-[80%] lg:w-[70%] w-full ">
            ...
            process is a mix of finding our what works, understanding what
            works, and building a strategy around the business with what works.
          </H_Tag>
